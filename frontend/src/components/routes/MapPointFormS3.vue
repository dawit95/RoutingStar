<template>
  <v-flex xs12 class="big-box">
    ...
    <button @click="upload">확인용 버튼</button>
  </v-flex>
</template>
...
export default {
  ...
  data () {
    return {
      ...
      IdentityPoolId: "ap-northeast-2:d4f3505d-434d-4a7c-abf5-20472e6b4676",
    }
  },
  computed: {
  ...
  methods: {
    ...
    upload() {
      ...
      // });
      const albumName = this.albumBucketName
      var albumPhotosKey = encodeURIComponent(albumName) + "/";

      var upload = new AWS.S3.ManagedUpload({
        apiVersion: "2006-03-01",
        params: {
          Bucket: albumPhotosKey,
